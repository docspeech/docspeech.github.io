<template>
  <div class="container mx-auto px-4 py-4">
    ...
    <p>
      ...
      continue to use DocSpeech if you do not agree to take all of the terms and
    ...
    <p>
      Unless otherwise stated, DocSpeech and/or its licensors own the
      intellectual property rights for all material on DocSpeech. All
      intellectual property rights are reserved. You may access this from
      DocSpeech for your own personal use subjected to restrictions set in these
      terms and conditions.
    </p>

    <p>You must not:</p>
    <ul>
      <li>Republish material from DocSpeech</li>
      <li>Sell, rent or sub-license material from DocSpeech</li>
      <li>Reproduce, duplicate or copy material from DocSpeech</li>
      <li>Redistribute content from DocSpeech</li>
    </ul>
    ...
    <p>
      ...
      opinions and information in certain areas of the website. DocSpeech does
      not filter, edit, publish or review Comments prior to their presence on
      the website. Comments do not reflect the views and opinions of DocSpeech,
      ...
      applicable laws, DocSpeech shall not be liable for the Comments or for any
    ...
    <p>
      DocSpeech reserves the right to monitor all Comments and to remove any
    ...
    <p>
      You hereby grant DocSpeech a non-exclusive license to use, reproduce, edit
      and authorize others to use, reproduce and edit any of your Comments in
      any and all forms, formats or media.
    </p>

    <h2><strong>Hyperlinking to our App</strong></h2>
    ...
    <ul>
      ...
      <li>
        Online directory distributors may link to our App in the same manner as
    ...
    <p>
      ...
      App information so long as the link: (a) is not in any way deceptive; (b)
      does not falsely imply sponsorship, endorsement or approval of the linking
      party and its products and/or services; and (c) fits within the context of
    ...
    <p>
      ...
      hyperlink compensates the absence of DocSpeech; and (d) the link is in the
      context of general resource information.
    </p>

    <p>
      These organizations may link to our App so long as the link: (a) is not in
    ...
    <p>
      ...
      interested in linking to our App, you must inform us by sending an e-mail
      to DocSpeech. Please include your name, your organization name, contact
      information as well as the URL of your site, a list of any URLs from which
      you intend to link to our App, and a list of the URLs on our site to which
    ...
    <p>
      No use of DocSpeech's logo or other artwork will be allowed for linking
    ...
    <p>
      We shall not be hold responsible for any content that appears on your App.
      You agree to protect and defend us against all claims that is rising on
      our App. No link(s) should appear on any Website that may be interpreted
      as libelous, obscene or criminal, or which infringes, otherwise violates,
    ...
    <p>
      ...
      particular link to our App. You approve to immediately remove all links to
      our App upon request. We also reserve the right to amen these terms and
      conditions and it’s linking policy at any time. By continuously linking to
      our App, you agree to be bound to and follow these linking terms and
      conditions.
    </p>

    <h2><strong>Removal of links from our App</strong></h2>

    <p>
      If you find any link on our App that is offensive for any reason, you are
    ...
    <p>
      ...
      representations, warranties and conditions relating to our App and the use
